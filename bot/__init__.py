...
DEFAULT_START_TEXT = (
    ...
    "AM smile killers pm assistant you can talk to him through me"
    ...
    "Join @NAZRIYAOFFTOPIC if you 😍 using this bot❗️❣️"
)
...
ONLINE_CHECK_START_TEXT = get_config(
    ...
    (
        ...
        "ℹ️ JOIN @NAZRIYAOFFTOPIC If you 😍 using this bot❗️❣️"
    )
)
# message to indicate,
...
DELETED_MESSAGES_NOTIFICATION_TEXT = get_config(
    ...
    (
        ...
        "This is an Open Source Project available on "
        "https://github.com/SpEcHiDe/NoPMsBot\n\n\n"
        "ℹ️ Subscribe @NAZRIYAOFDTOPIC if you 😍 using this bot❗️❣️"
